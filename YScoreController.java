...
public class YScoreController extends ScoreSheetsController{
    ...
    public void updateYellowScoreSheet(){
        YellowRealm yellowRealm=player.getYellowRealm();
        String[] prevAt=yellowRealm.getPreviousAttacks();        
        ...
        String[] drawRew=yellowRealm.getDrawRewards();        
    ...
    public void initialize() {
        ...
        theScoreSheet.setImage(new Image(getClass().getResourceAsStream("/images/YellowScoreSheet.png")));
